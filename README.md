# Các file data.txt, randomdata.txt, stat.txt, statRandom.txt, statsBinary.txt lưu trữ dữ liệu quá lớn nên chúng em để data để vẽ đồ thị các thuật toán trên google driver : 
